...
//   const filePath = `music/${Date.now()}_${musicFile.name}`;
...
//   const filePath = `images/${Date.now()}_${imageFile.name}`;  // safer unique name
...
//           <button onClick={handleMusicUpload} className="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-2 rounded transition duration-300">Upload Music</button>
...
//           <button onClick={handleImageUpload} className="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-2 rounded transition duration-300">Upload Image</button>
